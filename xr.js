...
return WebAssembly.validate(new Uint8Array([0,97,115,109,1,0,0,0,1,5,1,96,0,1,123,3,2,1,0,10,10,1,8,0,65,0,253,15,253,98,11]))}catch(e){return!1}},useAsync="false"!==s.getAttribute("async"),xrwebUrl="https://" + document.location.hostname + "/xr-27.4.11.427.js";let src=xrwebUrl||`${s.src}?appKey=${getAppKeyFromTag()}`;const xrwebSimdUrl="https://" + document.location.hostname + "/xr-simd-27.4.11.427.js",useSimd=xrwebSimdUrl&&checkSimdSupported();useSimd&&(src=xrwebSimdUrl);
...
window._XR8={channel:"js_release",version:"27.4.11.427",devMode:!1,sampleRatio:1,coverImageUrl:"https://cdn.8thwall.com/apps/cover/default3-preview-1200x630",smallCoverImageUrl:"https://cdn.8thwall.com/apps/cover/default3-preview-400x210",mediumCoverImageUrl:"https://cdn.8thwall.com/apps/cover/default3-preview-600x315",largeCoverImageUrl:"https://cdn.8thwall.com/apps/cover/default3-preview-1200x630"};
// Set up chunk map URLs depending if we're using simd or not.
const chunkPrefix="https://" + document.location.hostname + "/xr-27.4.11.427/";if(chunkPrefix){
